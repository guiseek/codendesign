...
import { ChangeDetectorRef, Component, ComponentRef, ElementRef, EmbeddedViewRef, HostBinding, HostListener, Inject, OnDestroy, Optional, ViewChild, ViewEncapsulation, ChangeDetectionStrategy } from '@angular/core';
...
export class CodeDialogContainer extends BasePortalOutlet implements OnDestroy {
  ...
  onAnimationStart($event) {
    return this._onAnimationStart($event);
  }

  @HostListener('@dialog.done', ['$event'])
  onAnimationDone($event) {
    return this._animationDone.next($event);
  }
