...
/** Token de injeção para o componente CodeDialogContainer do Dialog. */
export const DIALOG_CONTAINER = new InjectionToken<
  ComponentType<CodeDialogContainer>
>('CodeDialogContainer');

/** @ docs-private */
export function CODE_DIALOG_SCROLL_STRATEGY_PROVIDER_FACTORY(
  overlay: Overlay
): () => ScrollStrategy {
...
/** @ docs-private */
export const CODE_DIALOG_SCROLL_STRATEGY_PROVIDER = {
  provide: DIALOG_SCROLL_STRATEGY,
  deps: [Overlay],
  useFactory: CODE_DIALOG_SCROLL_STRATEGY_PROVIDER_FACTORY
};
